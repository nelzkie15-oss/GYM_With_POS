                                                                        ...
                                                                        <div class="card-inner">
                                                                          <form method="POST">
                                                                            <div class="row justify-content-left mb-3">
                                                                             <?php
                                                                              foreach($productInv as $row){ ?>
                                                                                <div class="col-6">
                                                                                    <?php
                                                                                       $FourDigitRandomNumber = '00'.$row['proinventory_id'];
                                                                                    ?>
                                                                                    
                                                                                    <button type="button" class="p-2 mb-2 btn_pos" style="background-color:#6ba1d1;color: #fff;border-color: #6ba1d1" id="product_select" data-idno="<?php echo $FourDigitRandomNumber; ?>" data-pro="<?= htmlentities($row['product']); ?>" data-qty="1" data-pri="<?= htmlentities($row['price']); ?>" data-ids="<?= htmlentities($row['proinventory_id']); ?>"><?= htmlentities(ucwords($row['product'])); ?></button>
                                                                                </div>
            ...
            $(document).ready(function() {
                ...
                $('.btn_pos').on('click', function() {
                    ...
                    var proinventory_id = $(this).data("ids");
                        ...
                        $.ajax({
                            url: 'main/config/process/pos_process.php',
                            type: 'POST',
                            data: {
                                idno: idno,
                                item_name: item_name,
