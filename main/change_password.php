                                               ...
                                               <div class="nk-block-head">
                                                   <form style="margin-left: 15%">
                                                       <div class="d-flex">
                                                           <div class="p-2 flex-fill">
                                                               <div class="form-group row">
                                                                   <label class="mt-1" style="font-weight: bold;">Current Password:</label>
                                                                   <div class="col-md-7">
                                                       ...
                                                       <div class="d-flex">
                                                           <div class="p-2 flex-fill">
                                                               <div class="form-group row">
                                                                   <label class="mt-1" style="font-weight: bold;">New Password:</label>
                                                                   <div class="col-md-7">
                                                                       <input type="text" class="form-control" id="date_of_birth">
                                                                   </div>
                                                               </div>
                                                       ...
                                                       <div class="d-flex">
                                                           <div class="p-2 flex-fill">
                                                               <div class="form-group row">
                                                                   <label class="mt-1" style="font-weight: bold;">Confirm Password:</label>
                                                                   <div class="col-md-7">
                                                                       <input type="text" class="form-control" id="date_of_birth">
                                                                   </div>
                                                               </div>
                                                       ...
                                                       <div class="d-flex">
                                                           ...
                                                           <div class="p-2 flex-fill">
                                                               <div class="form-group row">
                                                                   <input type="button" class="btn btn-info" value="Save" style="margin-right: 4%"><a href="main/account.php"><input type="button" class="btn btn-warning" value="Cancel"></a>
                                                               </div>
                                                           </div>
                                                           <div class="p-2 flex-fill">
                                                               <div class="form-group row">
