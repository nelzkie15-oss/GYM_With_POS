   <?php include 'navbar_sidebar/SideNav.php';?>
     <?php
            ...
            include_once('config/class/Gymmis_model.php');
             ...
             $trashid =  base64_decode(htmlentities($_GET['xde30ZvQ61cIv2']));
             $trash = $conn->view_member2($trashid);
             foreach ($trash as $row) {
                 ...
                 $trash_id = htmlentities($row['trash_id']);
                                    ...
                                    <div class="d-flex">
                                       ...
                                       <div class="d-flex">
	                                      ...
	                                      <div class="p-2 flex-fill">
		                                       ...
		                                       <div class="p-2 flex-fill">
									              <div class="form-group row">
									              	<input type="hidden" name="trash_id" id="trash_id" value="<?php echo $trash_id;?>">
									              	<input type="hidden" name="encryptedMemID" id="encryptedMemID" value="<?php echo $trashid;?>">
                                                           <input type="button" class="btn btn-info" value="Edit" id="btn-editmember2" style="margin-right: 4%"><a href="main/members_archived.php"><input type="button" class="btn btn-warning" value="Cancel"></a>
                                                        </div>
									             </div>
									          <div class="p-2 flex-fill">
									              <div class="form-group row">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        let btn = document.querySelector('#btn-editmember2');
        btn.addEventListener('click', (e) => {
            ...
            const trash_id = document.querySelector('input[id=trash_id]').value;
            ...
            data.append('trash_id', trash_id);
            data.append('encryptedMemID', encryptedMemID);
             
                $.ajax({
                    url: 'main/config/process/member_process_edit2.php',
                    type: "POST",
                    data: data,
                    processData: false,
                    contentType: false,
                    ...
                    success: function(response) {
                        $("#msg_editmem2").html(response).show().delay(1000).fadeOut(600);
                       },
