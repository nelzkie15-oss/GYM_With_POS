                                    ...
                                    <div class="card card-full overflow-hidden">
                                        ...
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <div class="row">
                                                <div class="col-md-10">
                                                    <h4 class="nk-block-title"> PRODUCT INVENTORY </h4> 
                                                </div>
                                            </div>
                                        ...
                                        <div id="results"></div>
                                              <div class="card card-preview">
                                                ...
                                                <div class="col-md-3">
                                                     ...
                                                     <a href="main/prodinv_stock_in.php"  style="margin-right: 4%"><input type="button" class="btn btn-info" value="STOCK IN"></a>   <a href="main/prodinv_stock_out.php"  style="margin-right: 4%"><input type="button" class="btn btn-danger" value="STOCK OUT"></a>
                                                    </div>
                                              </div>
                                               </div>
                                                    </div> <!-- nk-block -->
